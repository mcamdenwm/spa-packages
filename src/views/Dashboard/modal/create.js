...
const { failedToCreatePackage } = successMessages;
...
export default {
	...
	actions: {
		onPrimary: [{
			...
			payload: {
				request: {
					name: ['___state', ['Packages', 'CREATE', 'packageName']],
					description: ['___state', ['Packages', 'CREATE', 'internalNotes']],
					// companies: [], 
					features: ['___keys', ['___state', ['Packages', 'CREATE', 'selectedFeatures']]],
				},
			},
			meta: {
				swagger: {
					operationId: 'wm_package_create',
					onSuccess: {
						path: ['Packages', 'CREATE', 'new', 'success'],
					},
					onError: {
						path: ['Packages', 'CREATE', 'new', 'error'],
					},
				},
			}
		}, {
			...
			meta: {
				conditional: ['___and', [
					['___not', ['___state', ['Packages', 'CREATE', 'new', 'isFetching']]],
					['___isNil', ['___state', ['Packages', 'CREATE', 'new', 'error']]],
				]],
			}
		}, {
	...
	children: [
		generateAlertBanner(['___call', ['___constant', 'dashboard.lib.formatString'], failedToCreatePackage, ['___state', ['Packages', 'CREATE', 'packageName']] ], ['Packages', 'CREATE', 'new', 'error'], null, 'failedToCreatePackage-alert'),
		{
			type: 'WMGeneric',
			actions: {
				didMount: [{
